...
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_3 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^(?:.*?)\\\\\\\\s(?:.*?)\\\\\\\\s(?:.*?)\\\\\\\\s(?:.*?)\\\\\\\\s\\\\\\\\[(?P<http_info>.*?)\\\\\\\\]\\\\\\\\s\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_4; sleep 1
...
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_12 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^(?:.*?)\\\\\\\\s(?:.*?)\\\\\\\\s\\\\\\\\-\\\\\\\\s\\\\\\\\[(?P<http_info>.*?)\\\\\\\\]\\\\\\\\s\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_13; sleep 1
