...
result="$(wget --load-cookies /tmp/cookies.txt "https://drive.usercontent.google.com/download?export=download&confirm=t&uuid=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://docs.google.com/uc?export=download&id=1qqeOFxfjuZPzmJtKtdQazj4PYSo3edop' -O- | grep -Eo '\w{8}-\w{4}-\w{4}-\w{4}-\w{12}')&id=1qqeOFxfjuZPzmJtKtdQazj4PYSo3edop" -O apache-jmeter-5.5-gdcosta.tgz &> /tmp/k8s_output.txt && rm -rf /tmp/cookies.txt)"; sleep 1
cat /tmp/k8s_output.txt >> ~/debug.txt
result="$(cat /tmp/k8s_output.txt | grep "^HTTP" | tail -1 | sed -e 's/^HTTP request sent, awaiting response... //g;' | awk '{print $1}')"; sleep 1
if [ $result = 200 ]; then
echo " .... done"
...
transform_FW2_name="$(echo $WS_USER-_FW2_rename_sourcetype | sed -e 's/-_FW2_rename_sourcetype/_FW2_rename_sourcetype/g')"
transform_AW2_name="$(echo $WS_USER-_AW2_rename_sourcetype | sed -e 's/-_AW2_rename_sourcetype/_AW2_rename_sourcetype/g')"
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml.tmp
...
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_1 | sed -e "s/\[CHANGE\]/    processors:\n      transform\/$transform_FW2_name:\n        error_mode: ignore\n        log_statements:\n          - context: log\n            statements:\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_2; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_2 | sed -e "s/\[CHANGE\]/              # FW2 - change to dynamic sourcetype based on log event data\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_3; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_3 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^\\\\\\\\d{4}\\\\\\\\-\\\\\\\\d+\\\\\\\\-\\\\\\\\d+T\\\\\\\\d+\\\\\\\\:\\\\\\\\d+\\\\\\\\:\\\\\\\\d+\\\\\\\\.\\\\\\\\d+Z\\\\\\\\s\\\\\\\\w+\\\\\\\\s\\\\\\\\d+\\\\\\\\s---\\\\\\\\s\\\\\\\\[(?P<http_info>.*?)\\\\\\\\]\\\\\\\\s\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_4; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_4 | sed -e "s/\[CHANGE\]/              - set(attributes\[\"com.splunk.sourcetype\"\], attributes\[\"http_info\"\]) where attributes\[\"http_info\"\] != nil and resource.attributes\[\"com.splunk.sourcetype\"\] == \"kube:container:$WS_USER-petclinic-otel-container01\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_5; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_5 | sed -e "s/\[CHANGE\]/              # FW2 - change to static sourcetype based on log event data\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_6; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_6 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^(?P<exception_error>java\\\\\\\\.lang\\\\\\\\.NullPointerException)\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_7; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_7 | sed -e "s/\[CHANGE\]/              - set(attributes[\"com.splunk.sourcetype\"], \"kube:container:petclinic:java:exception:error\") where attributes\[\"exception_error\"\] == \"java.lang.NullPointerException\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_8; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_8 | sed -e "s/\[CHANGE\]/              # FW2 - add an additional severity key\/value pair based on log event data\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_9; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_9 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(\"ERROR\", \"^(?P<severity>.*)$\"), \"insert\") where attributes\[\"exception_error\"\] == \"java.lang.NullPointerException\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_10; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_10 | sed -e "s/\[CHANGE\]/      transform\/$transform_AW2_name:\n        error_mode: ignore\n        log_statements:\n          - context: log\n            statements:\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_11; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_11 | sed -e "s/\[CHANGE\]/              # AW2 - change to dynamic sourcetype based on log event data\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_12; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_12 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^\\\\\\\\d{4}\\\\\\\\-\\\\\\\\d+\\\\\\\\-\\\\\\\\d+\\\\\\\\s\\\\\\\\d+\\\\\\\\:\\\\\\\\d+\\\\\\\\:\\\\\\\\d+\\\\\\\\.\\\\\\\\d+\\\\\\\\s-\\\\\\\\s\\\\\\\\[(?P<http_info>.*?)\\\\\\\\]\\\\\\\\s\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_13; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_13 | sed -e "s/\[CHANGE\]/              - set(attributes\[\"com.splunk.sourcetype\"\], attributes\[\"http_info\"\]) where attributes\[\"http_info\"\] != nil and resource.attributes\[\"com.splunk.sourcetype\"\] == \"kube:container:$WS_USER-petclinic-otel-container01\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_14; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_14 | sed -e "s/\[CHANGE\]/              # AW2 - change to static sourcetype based on log event data\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_15; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_15 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^(?P<exception_runtime_error>java\\\\\\\\.lang\\\\\\\\.RuntimeException)\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_16; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_16 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^(?P<exception_nullpointer_error>java\\\\\\\\.lang\\\\\\\\.NullPointerException)\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_17; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_17 | sed -e "s/\[CHANGE\]/              - set(attributes[\"com.splunk.sourcetype\"], \"kube:container:petclinic:java:exception:error\") where attributes\[\"exception_runtime_error\"\] == \"java.lang.RuntimeException\" or attributes\[\"exception_nullpointer_error\"\] == \"java.lang.NullPointerException\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_18; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_18 | sed -e "s/\[CHANGE\]/              # AW2 - add an additional severity key\/value pair based on log event data\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_19; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_19 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(\"ERROR\", \"^(?P<severity>.*)$\"), \"insert\") where attributes\[\"exception_runtime_error\"\] == \"java.lang.RuntimeException\" or attributes\[\"exception_nullpointer_error\"\] == \"java.lang.NullPointerException\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_20; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_20 | sed -e "s/\[CHANGE\]/    service:\n      pipelines:\n        logs:\n          processors:\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_21; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_21 | sed -e "s/\[CHANGE\]/          - memory_limiter\n          - k8sattributes\n          - batch\n          - resourcedetection\n          - resource\n          - transform\/$transform_FW2_name\n          - transform\/$transform_AW2_name/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_22; sleep 1
rm ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml; sleep 1
mv ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_22 ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml; sleep 1
rm ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_*; sleep 1
if [ $? = 0 ]; then
echo " .... done"
else
