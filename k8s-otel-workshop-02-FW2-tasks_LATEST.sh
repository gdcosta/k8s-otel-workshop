...
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_15 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(body, \"^(?P<exception_error>java\\\\\\\\.lang\\\\\\\\.RuntimeException)\"), \"insert\")\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_16; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_16 | sed -e "s/\[CHANGE\]/              - set(attributes[\"com.splunk.sourcetype\"], \"kube:container:petclinic:java:exception:error\") where attributes\[\"exception_error\"\] == \"java.lang.RuntimeException\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_17; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_17 | sed -e "s/\[CHANGE\]/              # AW2 - add an additional severity key\/value pair based on log event data\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_18; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_18 | sed -e "s/\[CHANGE\]/              - merge_maps(attributes, ExtractPatterns(\"ERROR\", \"^(?P<severity>.*)$\"), \"insert\") where attributes\[\"exception_error\"\] == \"java.lang.RuntimeException\"\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_19; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_19 | sed -e "s/\[CHANGE\]/    service:\n      pipelines:\n        logs:\n          processors:\n\[CHANGE\]/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_20; sleep 1
cat ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_20 | sed -e "s/\[CHANGE\]/          - memory_limiter\n          - k8sattributes\n          - batch\n          - resourcedetection\n          - resource\n          - transform\/$transform_FW2_name\n          - transform\/$transform_AW2_name/g;" > ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_21; sleep 1
rm ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml; sleep 1
mv ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_21 ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml; sleep 1
rm ~/k8s_workshop/k8s_otel/splunk-otel-collector-chart/helm-charts/splunk-otel-collector/values.yaml_*; sleep 1
if [ $? = 0 ]; then
echo " .... done"
else
